  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full">
        ...
        {mutation?.isPending && (<StatusMessage type="loading" message="Please wait it's laoding..." />)}
        {/* Placeholder for success status */}
        {mutation?.isSuccess && (<StatusMessage type="loading" message="Plan is upgraded successfully..." />)}
